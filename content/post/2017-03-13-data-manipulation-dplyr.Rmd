...
Plot the number of unique names by year over time. Does it change? (Note in English, the same name could be given to a boy and a girl)
...
`dplyr` in a library for data transformation and manipulation. It is part of a collection of packages called [Tidyverse](http://www.tidyverse.org)
